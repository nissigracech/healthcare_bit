...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
			  ...
			  <tr>
			    <td height="38" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style7 style14 style3" style="margin-left:20px;"><strong>Post Spe Message</strong></div></td>
					  <td align="left" valign="middle" height="38"><div align="left" class="style4" style="margin-left:20px;">
                        <%out.println(s5);%>
                      </div></td>
			  </tr>
              ...
              <p align="right"><a href="allposts.jsp">Back</a></p>
