...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<tr>
					  <td  width="127" height="44" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7" style="margin-left:20px;"><strong>Friend Name</strong></div></td>
					...
					<tr>
					  <td height="38" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style7 style14 style3" style="margin-left:20px;"><strong>Description</strong></div></td>
			  ...
			  <tr>
			    <td height="38" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style7 style14 style3" style="margin-left:20px;"><strong>Message</strong></div></td>
					  <td align="left" valign="middle" height="38"><div align="left" class="style4" style="margin-left:20px;">
                        <%out.println(s5);%>
                      </div></td>
			  </tr>
			   <tr>
			     <td height="38" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style7 style14 style3" style="margin-left:20px;"><strong>Posted Date</strong></div></td>
					...
					<tr>
					  <td align="left" valign="middle" height="38" style="color: #2c83b0;"><div align="left " class="style3 style4 style14 style7" style="margin-left:20px;">Comment</div></td>
					...
					<tr>
					  <td  width="127" align="left" valign="middle" height="23" style="color: #2c83b0;">&nbsp;</td>
				...
				<%
					 ...
					 String msg=(String)application.getAttribute("mesg");
					 if(msg!=null){
					 %><h3><%=msg%></h3> <%
              ...
              <p align="right"><a href="friendsposts.jsp">Back</a></p>
