  ...
  <div id="content">
    <div class="wrapper">
      ...
      <div class="mainContent">
        <div class="section">
          <h2 class="style3">OSN Results </h2>
          <div class="indent">
           
              
              <iframe width="555" height="450" src="results.jsp?uname=<%=request.getParameter("uname") %>"></iframe>
              <p>&nbsp;</p>
          <a href="agentmain.jsp">Back</a></div>
        </div>
        <!-- box2 begin -->
        <div class="box2">
          <div class="inner"></div>
