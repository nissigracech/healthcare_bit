  ...
  <div id="content">
    <div class="wrapper">
      ...
      <div class="mainContent">
        <div class="section">
          <h2 class="style3"> Friends posts </h2>
          <div class="indent">
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		try 
		{
				...
				%>
				 <tr> 
				<td width="50" height="65" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Friend Post</div></td>
				<td width="50" height="65" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Friend Name</div></td>
				<td width="50" height="65" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Posted Post</div></td>
				<td width="60" height="65" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Details</div></td>
		   </tr>
				<%}
						...
						<tr>
					<td width="126" valign="middle" bgcolor="#FFFFFF" ><div class="style8" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
				<input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>" style="width:100px; height:100px;"/></a></div></td>
		 		 <td width="94" height="65" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">  <span class="style8">
	 		      <%out.println(rfrom);%>
		 		 </span></td>
			    <td width="126" valign="middle" bgcolor="#FFFFFF" ><div class="style8" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
				<input  name="image" type="image" src="profile_pic.jsp?id=<%=j%>&type=<%="post"%>" style="width:100px; height:100px;"/></a></div></td>
                <td  width="94" height="26"align="center" valign="middle" bgcolor="#FFFFFF" style="color:#000000;"><a href="viewpost.jsp?id=<%=j%>" class="style8">View post</a></td>
						</tr>
