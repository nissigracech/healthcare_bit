  ...
  <div id="content">
    <div class="wrapper">
      ...
      <div class="mainContent">
        <div class="section">
          <h2 class="style3">Users Behavior </h2>
          <div class="indent">
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
	...
	<%
		...
		try 
		{
			...
			String sql6="select title from comments where commented_user='"+uname+"'";
			...
			while(rs1.next())
			{
				...
				while(rs2.next())
				{
					...
					String sql="select * from comments where commented_user='"+uname+"' and title='"+s2+"'"; 
					...
					while(rs.next() )
					{
						...
						al.add(word);
						count=count+1;
						//s1=s1.replace(word,"<i><big><font>"+word+"</font></big></i>");
						}
			  ...
			  <h5><span class="style8">Postname</span>:<span class="style9"><a href="viewpostdetails1.jsp?pname=<%=s2%>"> <%=s2%></a></span></h5>
						<h5><span class="style8">Comment</span>:<span class="style10"> <%=s1%></span></h5>
						<h5><span class="style8">Word Type</span>: <%=wtype%></h5>
						<h5><span class="style8">Used words:</span> <%=al%></h5>
						<h5><span class="style8">Total words found:</span> <%=count%></h5>
						</br></br>
