  ...
  <div id="content">
    <div class="wrapper">
      ...
      <div class="mainContent">
        <div class="section">
          <h2 class="style3">  VIEW post Details !!! </h2>
          <div class="indent">
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<tr>
					  <td  width="127" height="44" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7" style="margin-left:20px;"><strong>Group Name</strong></div></td>
					  <td  width="182" valign="middle" height="44" style="color:#000000;"><div align="left" class="style4" style="margin-left:20px;">
					    <%out.println(grp);%></div></td>
					</tr>
              ...
              <p align="right"><a href="group_post.jsp">Back</a></p>
