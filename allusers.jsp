      ...
      <div class="mainContent">
        <div class="section">
          ...
          <div align="justify">
            ...
            <tr>
              <td  width="87" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style11">User Type</div></td>
              ...
              <td  width="98" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style11">Email</div></td>
              <td   width="54" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style11">status</div></td>
              <td  width="103" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style11">View</div></td>
            </tr>
		...
		s4=rs.getString(11);
            ...
            <tr>
              ...
              <%
						...
						%>
              <td  width="54" height="56" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style12">&nbsp;&nbsp; <a href="conformuser.jsp?mid=<%=i%>">waiting&nbsp;</a></span></td>
              <%
						}
						else
						{
						%>
              <td  width="103" height="56" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style12">&nbsp;&nbsp;
                  <%out.println(s4);%>
              </span></td>
              <%
						}
						...
						%>
              <td  width="135" height="56"align="center" valign="middle" bgcolor="#FFFFFF" style="color:#000000;"><a href="user_details1.jsp?mid=<%=i%>&back=<%="allusers"%>" class="style12">more info..&nbsp;</a></td>
            </tr>
            <%
						}
						connection.close();
